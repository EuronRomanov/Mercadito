         ...
         <div class="card text-left">
           ...
           <div class="card-body">
             <span class="btn btn-primary" data-toggle="modal" data-target="#agregarnuevosdatosmodal">
               Nuevo repartidor <span class="fa fa-plus-circle"></span>
             </span>
             <hr>
    ...
    <div class="modal-dialog  modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php include_once('masInformacion.php'); ?>
...
<!-- fin modal -->
 ...
 <!-- Optional JavaScript -->
    ...
    <script src="../../js/repartidor/validateAdd.js"></script>
    <script src="../../js/repartidor/validateUpdate.js"></script>
    <script src="../../js/repartidor/CRUD_repartidor.js"></script>
    <script src="../../js/repartidor/carga_repartidor.js"></script>
    <script src="../../js/repartidor/formulario.js"></script>
