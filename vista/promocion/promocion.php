         ...
         <div class="card text-left">
           ...
           <div class="card-body">
             <span class="btn btn-primary" data-toggle="modal" data-target="#agregarnuevosdatosmodal">
               Nueva Descuento <span class="fa fa-plus-circle"></span>
             </span>
             <hr>
...
<!-- fin modal -->
 ...
 <!-- Optional JavaScript -->
    ...
    <script src="../../js/promocion/validateAdd.js"></script>
     <script src="../../js/promocion/carga_promocion.js"></script>
    <script src="../../js/promocion/formulario.js"></script>
    <script src="../../js/promocion/CRUD_promocion.js"></script>
