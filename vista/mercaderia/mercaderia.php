...
<html>
<head>
  <title>Entrada de mercaderia</title>
         ...
         <div class="card text-left">
           ...
           <div class="card-body">
             <span class="btn btn-primary" data-toggle="modal" data-target="#agregarnuevosdatosmodal">
               Nueva Entrada <span class="fa fa-plus-circle"></span>
             </span>
             <hr>
    ...
    <div class="modal-dialog  modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Nueva Mercaderia</h5>
...
<!-- fin modal -->
 ...
 <!-- Optional JavaScript -->
    ...
    <script src="../../js/categoria/validateAdd.js"></script>
     <script src="../../js/categoria/carga_categoria.js"></script>
    <script src="../../js/mercaderia/formulario.js"></script>
    <script src="../../js/mercaderia/CRUD_mercaderia.js"></script>
