         ...
         <div class="card text-left">
           ...
           <div class="card-body">
             <span class="btn btn-primary" data-toggle="modal" data-target="#agregarnuevosdatosmodal">
               Nuevo Producto <span class="fa fa-plus-circle"></span>
             </span>
             <hr>
...
<!-- fin modal -->
 ...
 <!-- Optional JavaScript -->
    ...
    <script src="../../js/producto/validateAdd.js"></script>
    <script src="../../js/producto/validateUpdate.js"></script>
    <script src="../../js/producto/CRUD_producto.js"></script>
    <script src="../../js/producto/carga_producto.js"></script>
