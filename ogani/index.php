    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__auth">
                <a href="vista/login/index.php"><i class="fa fa-user"></i> Login</a>
            </div>
        </div>
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li class="active"><a href="ogani/index.php">Home</a></li>
                <li><a href="ogani/shop-grid.html">Shop</a></li>
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="ogani/shop-details.html">Shop Details</a></li>
                        <li><a href="ogani/shoping-cart.html">Shoping Cart</a></li>
                        <li><a href="ogani/checkout.html">Check Out</a></li>
                        <li><a href="ogani/blog-details.html">Blog Details</a></li>
                    </ul>
                </li>
                <li><a href="ogani/blog.html">Blog</a></li>
                <li><a href="ogani/contact.html">Contact</a></li>
            </ul>
        </nav>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="ogani/index.php"><img src="ogani/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
